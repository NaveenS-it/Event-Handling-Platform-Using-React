...
function processFile(filePath) {
    ...
    content = content.replace(/bg-dark-glass/g, 'bg-white shadow-sm border border-gray-100');
    ...
    // Header text replacements specific
    content = content.replace(/text-transparent/g, 'text-gray-900');
    content = content.replace(/bg-gradient-to-tr from-primary to-secondary/g, 'bg-gray-100');
